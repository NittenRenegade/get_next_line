...
/*   Updated: 2021/12/03 19:31:45 by coskelet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

static ssize_t	read_buf(int fd, t_list *lst);
static char		*get_from_buf(t_list **lst, ssize_t str_size);
static void		con_alloc(char *str, ssize_t str_size, t_list **lst);
static ssize_t	get_nl_pos(t_list *lst, ssize_t	*i);
